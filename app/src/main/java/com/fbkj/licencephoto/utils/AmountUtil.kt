...
open class AmountUtil {
    /**
     * 金额为分的格式
     */
    private val CURRENCY_FEN_REGEX = "\\-?[0-9]+"
    ...
    companion object {
        ...
        @Volatile
        private var INSTANCE: AmountUtil? = null
        fun getInstance() = INSTANCE ?: synchronized(AmountUtil::class.java) {
            INSTANCE ?: AmountUtil().also { INSTANCE = it }
        }
    }
}