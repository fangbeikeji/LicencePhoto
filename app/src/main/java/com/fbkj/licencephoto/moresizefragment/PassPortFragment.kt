...
class PassPortFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val jsonString = JsonFetch().getJson(requireContext(), "passport_licence.json")
        val result = RetrofitHelper.gson.fromJson<SizeModel>(jsonString, object : TypeToken<SizeModel>() {}.type)
